...
full_json_5 = slorion.replace_params_with_threshold(NEST,string_parameters_5,threshold=threshold,keyword_threshold=threshold)
...
full_json_10 = slorion.replace_params_with_threshold(NEST,string_parameters_10,threshold=threshold,keyword_threshold=threshold)
...
full_json_20 = slorion.replace_params_with_threshold(NEST,string_parameters_20,threshold=threshold,keyword_threshold=threshold)
...
full_json_40 = slorion.replace_params_with_threshold(NEST,string_parameters_40,threshold=threshold,keyword_threshold=threshold)
